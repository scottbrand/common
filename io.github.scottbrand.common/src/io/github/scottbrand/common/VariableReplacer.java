...
/**
 * VariableReplacer is a simple utility class that allows for basic variable
...
public final class VariableReplacer
{
     ...
     */
    public static final String replaces(String value, Map<String, Object> replacementMap)
    {
        return new VariableReplacer().replace(value, replacementMap);
    }
     ...
     * @return a String with captured variables replaced.
     */
    public static final String replaces(String value, Map<String, Object> replacementMap, boolean throwExceptionWhenNoReplacement) throws IllegalArgumentException
    {
        return new VariableReplacer().replace(value, replacementMap,throwExceptionWhenNoReplacement);
    }
     ...
     * @return a String with captured variables replaced.
     */
    public String replace(String value, Map<String, Object> replacementMap)
    {
     ...
     * @return a String with captured variables replaced.
     */
    public String replace(String value, Map<String, Object> replacementMap, boolean throwExceptionWhenNoReplacement) throws IllegalArgumentException
    {
    ...
    private String replaceKey(String matchKey, Map<String, Object> replacementMap)
    {
