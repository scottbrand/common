 ...
 * </p>
 * <p>
 * To accomplish this you can register a {@link ResourceFilter} as an OSGi service. The JAX-RS publisher will prefer use
 * this service to construct it's {@link ServiceTracker}.
 * </p>
 * 
 * <p>
 * <b>Please Note:</b> Right now the {@link ResourceFilter} service must be registered before the publisher bundle is
 * started. Dynamic behavior may follow in future versions.
 * </p>
 * 
 * @see Filter
 * 
