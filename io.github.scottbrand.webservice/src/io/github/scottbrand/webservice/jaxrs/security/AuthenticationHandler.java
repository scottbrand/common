 ...
 * Client may implement this interface to perform user authentication and to define an authentication scheme. These
 * values will be used later on in a {@link SecurityContext} that is used by the framework to verify authentication.
 * </p>
 * <p>
...
public interface AuthenticationHandler
{
	...
	/**
	 * <p>
	 * Authenticates the user initiating the request. Implementations must return null if the user could not be
	 * authenticated.
	 * </p>
	 * 
	 * @param requestContext
	 *            the request context supplied by the underlying JAX-RS implementation.
	 * @return a principal representing the authenticated user initiating the request or {@code null} if the user could
