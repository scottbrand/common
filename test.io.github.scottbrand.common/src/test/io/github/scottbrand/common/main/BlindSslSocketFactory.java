...
public class BlindSslSocketFactory extends SocketFactory
{
	...
	public static void main(String[] args)
	{
		...
		// complete URL of Active Directory/LDAP server running SSL with invalid
		// cert
		String url = "ldaps://ldapinternal.neustar.biz/";
...
//		String password = "<PASSWORD>";
		...
		env.put(Context.SECURITY_PRINCIPAL, "uid=sbrand,​ou=neustar,​ou=staff,​o=neustar");
		env.put(Context.SECURITY_CREDENTIALS, "Juls0417");
